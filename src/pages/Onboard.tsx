...
export default function Onboard() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // TODO(Phase 4): insert into `sites` via getSupabase(), upload
    // logo/profilePhoto/photos to the site-assets bucket, and redirect to
    // /thank-you/:siteId. Stubbed for now — Phase 0 only re-homes the
    // wizard UI onto the new stack.
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="medical" disabled>Medical (coming soon)</option>
                <option value="real-estate" disabled>Real Estate (coming soon)</option>
              </select>
            </div>
          </div>
        );
